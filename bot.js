...
const WALLET_DATA_PROPERTY = 'walletDataProperty';
...
class BasicBot {
    ...
    constructor(conversationState, userState, botConfig) {
        ...
        this.walletDataAccessor = userState.createProperty(WALLET_DATA_PROPERTY);
            ...
            if (context.activity.membersAdded.length !== 0) {
                ...
                for (var idx in context.activity.membersAdded) {
                    ...
                    if (context.activity.membersAdded[idx].id !== context.activity.recipient.id) {
                        ...
                        await context.sendActivity('Hello, welcome to IKOFI. What can I do for you?');
                    }
                }
            }
        }
    ...
    async updateUserProfile(luisResult, context) {
        ...
        if (Object.keys(luisResult.entities).length !== 1) {
            ...
            if (userProfile === undefined) {
                userProfile = new UserProfile('1360000004');
            }
            if (luisResult.entities.number !== undefined) {
                // 1 number, 4 digits
                // 4 numbers, 1 digit each
                userProfile.pin = luisResult.entities.number.reduce((pin, element) => pin + '' + element);
            }
